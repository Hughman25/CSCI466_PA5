...
if __name__ == '__main__':
    ...
    encap_tbl_D = {0 : "H3", 1: "H3"}# table used to encapsulate network packets into MPLS frames
    #{(inlabel, in-interface) : (outlabel, out-interface)}
    frwd_tbl_D = {("H3", 0) : ("H3", 2), ("H3", 1) : ("H3", 3), ("H1", 2): ("H1", 0), ("H2", 3): ("H2", 1), ("H1", 1): ("H1", 0), ("H2", 0): ("H2", 1)}# table used to forward MPLS frames
    decap_tbl_D = {2 : "H1", 3: "H2"}    # table used to decapsulate network packets from MPLS frames
    ...
    encap_tbl_D = {}   
    frwd_tbl_D = {("H3", 0) : ("H3", 1), ("H1", 1) : ("H1", 0)}    
    decap_tbl_D = {}
    ...
    encap_tbl_D = {}   
    frwd_tbl_D = {("H3", 0) : ("H3", 1), ("H2", 1) : ("H2", 0)}    
    decap_tbl_D = {}
